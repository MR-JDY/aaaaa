...
public interface CommonStandard {
	...
	//原生field
		...
		public static final int transactionCardTtl = 300;
...
//		};
		...
		public static final long DISTRIBUTED_LOCK_WAIT_MS = 100;		//分布式加锁等待时间,毫秒
		...
		public static final int DISTRIBUTED_LOCK_RETRY_TIME = 15;			//分布式锁的重试次数
